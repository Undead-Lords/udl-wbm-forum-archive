...
const fileExists = (file) => {
	...
	if(!file.substr(-4).includes('-')){
		...
		let num = Number(file.substring(file.lastIndexOf('-')+1));
		num++;
...
const parseHTML = (html, date) => {
	...
	if(pHtml.match(regexp) !== null){
		...
		if(Number(tempDesc) > 1) {
			jsonArr.push({"dateOfActivity": date, "description": `${tempDesc} people using the forum at the time of the snapshot`})
		}
	}
...
const valDay = (day) => {
	day = day.split('');
	day = day.map(x => {if(isNaN(Number(x))) {return ''}else{return x}}).join('');
...
//parseURL("https://web.archive.org/web/20051224100530/http://www.undeadlords.net/forums/index.php?showforum=2");
parseURL("https://web.archive.org/web/20051224100530/http://www.undeadlords.net/forums/index.php?showforum=2");
//parseURL("https://web.archive.org/web/20051224093807/http://www.undeadlords.net/forums/index.php?showuser=50");
//parseURL("https://web.archive.org/web/20051224114258/http://www.undeadlords.net/forums/index.php?showuser=3");
//parseURL("https://web.archive.org/web/20051224101501/http://www.undeadlords.net/forums/index.php?showuser=21");
//parseURL("https://web.archive.org/web/20051224100728/http://www.undeadlords.net/forums/index.php?showuser=259");
//parseURL("https://web.archive.org/web/20051224113714/http://www.undeadlords.net/forums/index.php?showforum=3");
//parseURL("https://web.archive.org/web/20051224101428/http://www.undeadlords.net/forums/index.php?showforum=4");
//parseURL("https://web.archive.org/web/20051224113804/http://www.undeadlords.net/forums/index.php?act=Members");
//parseURL("https://web.archive.org/web/20051224092057/http://www.undeadlords.net/forums/index.php?act=calendar");
//parseURL("https://web.archive.org/web/20051103035945/http://www.undeadlords.net:80/forums/");
//parseURL("https://web.archive.org/web/20051224103928/http://www.undeadlords.net/forums/index.php?showforum=26");
//parseURL("https://web.archive.org/web/20051224094955/http://www.undeadlords.net/forums/index.php?showuser=25");
//parseURL("https://web.archive.org/web/20051224092409/http://www.undeadlords.net/forums/index.php?showuser=91");
//parseURL("https://web.archive.org/web/20051224094546/http://www.undeadlords.net/forums/index.php?showuser=253");
//parseURL("https://web.archive.org/web/20050212085048/http://www.undeadlords.net:80/forums/");
//parseURL("https://web.archive.org/web/20051025182332/http://www.undeadlords.net:80/forums/");
//parseURL("https://web.archive.org/web/20061127213039/http://www.undeadlords.net:80/forums/");
//parseURL("https://web.archive.org/web/20061117040221/http://www.undeadlords.net:80/forums/");
//parseURL("https://web.archive.org/web/20061108163549/http://www.undeadlords.net:80/forums/");
//parseURL("https://web.archive.org/web/20061026201254/http://www.undeadlords.net:80/forums/");
//parseURL("https://web.archive.org/web/20060518091950/http://www.undeadlords.net:80/forums/");
